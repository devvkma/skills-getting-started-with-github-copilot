...
activities = {
    ...
    "Theater Club": {
        "description": "Acting, stagecraft, and full-play productions throughout the year",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 30,
        "participants": ["amelia@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking, research, and compete in debate competitions",
